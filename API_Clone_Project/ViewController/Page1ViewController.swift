...
//  API_Clone_Project
//
//  Created by 백래훈 on 2022/03/10.
//

import UIKit

class Page1ViewController: UIPageViewController {
    ...
    func page1ViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
...
extension Page1ViewController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
